...
<?php $__env->startSection('page-subtitle', 'Configure application-wide settings'); ?>
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="app_name" class="form-control"
                                value="<?php echo e($settings['app_name'] ?? 'CHAMS'); ?>">
                            <small class="text-muted">Displayed in browser title and sidebar</small>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Company Name</label>
                            <input type="text" name="company_name" class="form-control"
                                value="<?php echo e($settings['company_name'] ?? 'Clinical Health Appointment Management System'); ?>">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="app_timezone" class="form-select">
                                <option value="Asia/Manila"
                                    <?php echo e(($settings['app_timezone'] ?? '') == 'Asia/Manila' ? 'selected' : ''); ?>>Asia/Manila
                                    (GMT+8)</option>
                                <option value="UTC" <?php echo e(($settings['app_timezone'] ?? '') == 'UTC' ? 'selected' : ''); ?>>
                                    UTC</option>
                                <option value="America/New_York"
                                    <?php echo e(($settings['app_timezone'] ?? '') == 'America/New_York' ? 'selected' : ''); ?>>
                                    America/New York</option>
                                <option value="Europe/London"
                                    <?php echo e(($settings['app_timezone'] ?? '') == 'Europe/London' ? 'selected' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <input type="color" name="primary_color" class="form-control form-control-color"
                                    style="width: 60px;" value="<?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>">
                                <input type="text" class="form-control"
                                    value="<?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>" id="primary_color_text" readonly>
                                <div class="color-preview"
                                    style="background-color: <?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>"></div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                <input type="color" name="sidebar_color" class="form-control form-control-color"
                                    style="width: 60px;" value="<?php echo e($settings['sidebar_color'] ?? '#2a1a2e'); ?>">
                                <input type="text" class="form-control"
                                    value="<?php echo e($settings['sidebar_color'] ?? '#2a1a2e'); ?>" id="sidebar_color_text" readonly>
                                <div class="color-preview"
                                    style="background-color: <?php echo e($settings['sidebar_color'] ?? '#2a1a2e'); ?>"></div>
                            </div>
                    ...
                    <div class="mt-3 p-3 rounded" style="background-color: #f5f0f7;">
                        ...
                        <div class="d-flex gap-2 flex-wrap">
                            <button class="btn btn-primary"
                                style="background-color: <?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>; border-color: <?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>">
                                <i class="bi bi-check me-1"></i>Primary Button
                            </button>
                            <button class="btn btn-outline-primary"
                                style="color: <?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>; border-color: <?php echo e($settings['primary_color'] ?? '#8b5a8f'); ?>">
                                Outline Button
                            </button>
                            <div class="p-2 rounded"
                                style="background: <?php echo e($settings['sidebar_color'] ?? '#2a1a2e'); ?>; color: white;">
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            ...
                            <input type="time" name="business_start_time" class="form-control"
                                value="<?php echo e($settings['business_start_time'] ?? '09:00'); ?>">
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">End Time</label>
                            <input type="time" name="business_end_time" class="form-control"
                                value="<?php echo e($settings['business_end_time'] ?? '17:00'); ?>">
                        </div>
                        <div class="col-md-4">
                            ...
                            <input type="number" name="appointment_duration" class="form-control"
                                value="<?php echo e($settings['appointment_duration'] ?? '30'); ?>" step="15" min="15">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="form-check form-switch">
                                ...
                                <input type="checkbox" name="enable_email_notifications" class="form-check-input"
                                    ...
                                    <?php echo e($settings['enable_email_notifications'] ?? false ? 'checked' : ''); ?>>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="reminder_hours_before" class="form-control"
                                value="<?php echo e($settings['reminder_hours_before'] ?? '24'); ?>" min="1">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="email" name="admin_notification_email" class="form-control"
                                value="<?php echo e($settings['admin_notification_email'] ?? 'admin@chams.com'); ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex gap-2 mt-3">
                    ...
                    <a href="<?php echo e(route('admin.settings.reset')); ?>" class="btn btn-outline-danger"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\laravel patient-appointment-tracker\patient-appointment-tracker\laravel chams github\IT-9-Final-Project-Appointment-System-CHAMS\resources\views/settings/index.blade.php ENDPATH**/ ?>