...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Patient Appointment Tracker'); ?></title>
    ...
    <div class="d-flex">
        ...
        <div class="sidebar col-2 p-3">
            <div class="mb-4 d-flex align-items-center gap-2">
                <img src="<?php echo e(asset('images/PAMS logo.png')); ?>" alt="Logo" style="width: 70px; height: auto;">
                <div>
            ...
            <nav class="d-flex flex-column gap-1">
                ...
                <a href="<?php echo e(route('clients.index')); ?>"
                    class="nav-link <?php echo e(request()->routeIs('clients.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('appointments.index')); ?>"
                    ...
                    <?php if($todayCount > 0): ?>
                        <span class="badge bg-warning text-dark badge-today ms-1"><?php echo e($todayCount); ?></span>
                    <?php endif; ?>
                </a>
...
<?php /**PATH C:\xampp\laravel patient-appointment-tracker-copy\CHAMS\resources\views/layouts/app.blade.php ENDPATH**/ ?>