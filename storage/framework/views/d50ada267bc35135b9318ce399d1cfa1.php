                            ...
                            <?php $__currentLoopData = $appointments->where('status', $statusValue); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="card mb-2 kanban-card shadow-sm" data-id="<?php echo e($appt->id); ?>"
                                    ...
                                    <div class="card-body p-2">
                                        <p class="fw-semibold mb-0 small"><?php echo e($appt->client->full_name); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\laravel patient-appointment-tracker\patient-appointment-tracker\laravel chams github\IT-9-Final-Project-Appointment-System-CHAMS\resources\views/appointments/kanban.blade.php ENDPATH**/ ?>