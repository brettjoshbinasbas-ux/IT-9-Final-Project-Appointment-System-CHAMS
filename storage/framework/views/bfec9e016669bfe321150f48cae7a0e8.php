...
<?php $__env->startSection('page-subtitle', 'Register a new client record'); ?>
...
unset($__errorArgs, $__bag); ?>" rows="2"
                                    placeholder="Address (optional)"><?php echo e(old('address')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" rows="2"
                                    placeholder="Additional notes (optional)"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <a href="<?php echo e(route('clients.index')); ?>" class="btn btn-outline-secondary">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\laravel patient-appointment-tracker-final\IT-9-Final-Project-Appointment-System-CHAMS\resources\views/clients/create.blade.php ENDPATH**/ ?>